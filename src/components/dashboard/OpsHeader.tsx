  ...
  return (
    <header className="flex items-center justify-between px-10 py-10 bg-transparent sticky top-0 z-40">
      ...
      <div className="flex items-center gap-8">
        <button className="bg-[#005c97] text-white px-8 py-4 rounded-[24px] text-xs font-black uppercase tracking-widest shadow-xl shadow-blue-900/10 hover:shadow-2xl hover:scale-105 transition-all">
           New Booking
        </button>

        <button className="p-4 bg-white/60 backdrop-blur-xl border border-gray-100 rounded-2xl text-gray-400 hover:bg-white hover:shadow-2xl hover:shadow-gray-100 transition-all group">
